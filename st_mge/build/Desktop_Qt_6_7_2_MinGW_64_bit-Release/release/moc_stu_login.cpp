...
void stu_login::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sendLoginSuccess((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        ...
        {
            using _t = void (stu_login::*)(const QString & , const QString & );
...
// SIGNAL 0
void stu_login::sendLoginSuccess(const QString & _t1, const QString & _t2)
{
